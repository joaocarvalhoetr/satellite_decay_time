...
# Geometric Altitudes data in km K/km
...
def density_MET(z, T_exo):
    ...
    h_MET = np.array([0, 25, 30, 40, 50, 60, 70, 80,
                    ...
                    480, 490, 500, 600, 700, 800, 900, 1000])

    # Corresponding densities (kg/m^3) for T_Exosphere = 2200k
    r_MET_2200 = np.array([1.225, 4.008e-2, 1.841e-2, 3.996e-3, 1.027e-3, 3.097e-4, 8.283e-5, 1.846e-5, 
                          ...
                          2.541e-10, 0.17454e-9, 0.14889e-9, 0.12810e-9, 0.11100e-9, 0.96764e-10, 0.84794e-10, 
                          0.74637e-10, 0.65953e-10, 0.58479e-10, 0.52009e-10, 0.46381e-10, 0.41464e-10,
                          0.37151e-10, 0.33356e-10, 0.30005e-10, 0.27039e-10, 0.24407e-10, 0.22065e-10,
                          0.19978e-10, 0.18113e-10, 0.16445e-10, 0.14949e-10, 0.13606e-10, 0.12398e-10, 
                          0.11311e-10, 0.10329e-10, 1.137e-13, 3.070e-14, 1.136e-14, 5.759e-15, 3.561e-15])

    # Corresponding densities (kg/m^3) for T_Exosphere = 1400k
    r_MET_1400 = np.array([1.225, 4.008e-2, 1.841e-2, 3.996e-3, 1.027e-3, 3.097e-4, 8.283e-5, 1.846e-5, 
                          3.416e-6, 5.606e-7, 9.708e-8, 2.222e-8, 8.152e-9, 3.831e-9, 2.076e-9, 5.194e-10,
                          2.541e-10, 0.12326e-9, 0.10075e-9, 0.82965e-10, 0.68965e-10, 0.57348e-10, 0.48074e-10,
                          0.40492e-10, 0.34254e-10, 0.29092e-10, 0.24799e-10, 0.21211e-10, 0.18199e-10,
                          0.15660e-10, 0.13513e-10, 0.11689e-10, 0.10136e-10, 0.88081e-11, 0.76706e-11,
                          0.66931e-11, 0.58509e-11, 0.51237e-11, 0.44941e-11, 0.39480e-11, 0.34733e-11,
                          0.30600e-11, 0.26993e-11, 1.137e-13, 3.070e-14, 1.136e-14, 5.759e-15, 3.561e-15])
    # Corresponding densities (kg/m^3) for T_Exosphere = 600k
    r_MET_600 = np.array ([1.225, 4.008e-2, 1.841e-2, 3.996e-3, 1.027e-3, 3.097e-4, 8.283e-5, 1.846e-5, 
                          3.416e-6, 5.606e-7, 9.708e-8, 2.222e-8, 8.152e-9, 3.831e-9, 2.076e-9, 5.194e-10,
                          2.541e-10, 0.18483e-10, 0.13158e-10, 0.94599e-11, 0.68587e-11, 0.50090e-11, 0.36812e-11,
                          0.27202e-11, 0.20199e-11, 0.15064e-11, 0.11279e-11, 0.84770e-12, 0.63945e-12,
                          0.48413e-12, 0.36791e-12, 0.28069e-12, 0.21506e-12, 0.16555e-12, 0.12808e-12,
                          0.99660e-13, 0.78036e-13, 0.61535e-13, 0.48899e-13, 0.39189e-13, 0.31695e-13,
                          0.25886e-13, 0.21359e-13, 1.137e-13, 3.070e-14, 1.136e-14, 5.759e-15, 3.561e-15])
